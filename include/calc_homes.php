...
if ($cnt > 0):
    ...
    <section class="calc" id="calc">
        ...
        <div id="calculator" class="calculator_homes">
            <div class="row">
                ...
                $citiesRes = CIBlockSection::GetList(array(), $arFilter, false, false);
                ?>
            ...
            <div class="row">
				...
				<a href="#calc_description" class="show_calc_description">
                    <span style="padding-top:6px;">Адресная программа</span>
                </a>
            </div>
